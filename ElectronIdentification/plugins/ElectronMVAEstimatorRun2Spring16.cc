#include "RecoEgamma/ElectronIdentification/interface/ElectronMVAEstimatorRun2Spring16.h"
...
ElectronMVAEstimatorRun2Spring16::ElectronMVAEstimatorRun2Spring16(const edm::ParameterSet& conf):
...
void ElectronMVAEstimatorRun2Spring16::setConsumes(edm::ConsumesCollector&& cc) const {
...
int ElectronMVAEstimatorRun2Spring16::findCategory( const edm::Ptr<reco::Candidate>& particle) const {
...
bool ElectronMVAEstimatorRun2Spring16::
...
std::unique_ptr<const GBRForest> ElectronMVAEstimatorRun2Spring16::
...
void ElectronMVAEstimatorRun2Spring16::constrainMVAVariables(AllVariables& allMVAVars) const {
